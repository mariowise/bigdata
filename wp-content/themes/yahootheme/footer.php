		...
		<footer>
			...
			<div id="footer-small">
				<div class="row">
					<div>
						Sitio web construido con wordpress por <a href="http://mariowise.wordpress.com/">@mariowise</a>
					</div>
				</div>
			</div>
	...
	<script src="<?php bloginfo('template_directory');?>/javascripts/vendor/jquery.js"></script>
